...
internal struct SyntaxStructure: Codable {
    ...
    internal init(accessibility: ElementAccessibility?,
                  attribute: String?,
                  attributes: [SyntaxStructure]?,
                  elements: [SyntaxStructure]?,
                  inheritedTypes: [SyntaxStructure]?,
                  kind: ElementKind?,
                  name: String?,
                  runtimename: String?,
...
///
enum ElementAccessibility: String, RawRepresentable, Comparable {
